...
export default async function AdminDashboard() {
  await requireAdmin();
  const sections = [["Products", "/admin/products"], ["Editorial Lists", "/admin/editorial-lists"], ["Stories", "/admin/stories"], ["Articles", "/admin/articles"], ["Affiliate Links", "/admin/affiliate-links"], ["Categories", "/admin/categories"]] as const;
