...
export function Footer() {
  return <footer className="site-footer mt-32 border-t bg-[#000000] text-white">
    <div className="shell grid gap-16 py-20 md:grid-cols-[1.6fr_1fr_1fr]">
      ...
      <div><p className="eyebrow !text-[#2180F8]">Discover</p><div className="mt-5 flex flex-col gap-3 text-sm text-[#cbd0da]"><Link href="/tools" className="hover:text-white">Explore tools</Link><Link href="/categories" className="hover:text-white">Categories</Link><Link href="/best/ai-tools" className="hover:text-white">Best picks</Link></div></div>
